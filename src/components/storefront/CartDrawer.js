  ...
  return (
    <>
      <style>{`
        ...
        .cdr-checkout{width:100%;padding:16px;background:#c9a86c;border:none;color:#080808;font-size:12px;font-weight:500;letter-spacing:0.15em;text-transform:uppercase;cursor:pointer;transition:background 0.2s}
      ...
      <div className={`cdr-drawer${isOpen ? ' open' : ''}`}>
        ...
        {items.length > 0 && (
          <div className="cdr-foot">
            ...
            <button className="cdr-checkout">Proceed to Checkout</button>
